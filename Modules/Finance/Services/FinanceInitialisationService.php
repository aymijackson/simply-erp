...
class FinanceInitialisationService
{
    ...
    protected function seedMappings(int $companyId): array
    {
        ...
        DB::table('finance_account_mappings')->insert([
            ...
            'cogs_account_id'=>$accounts['5000'] ?? null,
            'inventory_asset_account_id'=>$accounts['1200'] ?? null,
            'wip_account_id'=>$accounts['1210'] ?? null,
            'finished_goods_account_id'=>$accounts['1220'] ?? null,
