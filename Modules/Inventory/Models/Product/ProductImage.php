...
class ProductImage extends Model
{
    ...
    protected static function booted(): void
    {
        static::creating(function (self $image) {
            if (is_null($image->sort_order)) {
                $max = static::where('product_id', $image->product_id)->max('sort_order');
    ...
    */
    ...
    public static function ensurePrimaryExists(int $productId): void
    {
    ...
    {
        return route('admin.inventory.products.images.view', $this->id);
    }
