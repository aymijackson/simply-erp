...
@php
    ...
    $visibleLinks = collect($featureLinks)->filter(function ($item) {
        return Route::has($item['route']) && (!function_exists('canAccessModule') || true);
    });
@endphp
...
<div class="container-fluid">
        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-3">
                <div>
                    ...
                    <p class="guide-muted mb-0">The tiles below are designed for integration into Simply-ERP. Use route and permission checks before showing each tile.</p>
                </div>
            </div>
    ...
    <div class="guide-card mb-4">
        <div class="card-body">
            <h2 class="guide-section-title">7. Suggested route and menu integration</h2>
            <p class="guide-muted">Add this page to the Procurement menu as a help or guide page so new users can learn the workflow without leaving the ERP.</p>
            <div class="row g-3">
                <div class="col-lg-6">
<pre class="bg-light p-3 rounded small mb-0"><code>// Route example
Route::get('/admin/procurement/guide', [\Modules\Procurement\Http\Controllers\ProcurementGuideController::class, 'index'])
    ->name('admin.procurement.guide')
