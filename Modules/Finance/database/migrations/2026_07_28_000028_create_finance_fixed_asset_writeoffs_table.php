...
return new class extends Migration {
    ...
    {
        if (Schema::hasTable('finance_fixed_asset_writeoffs')) {
            return;
        }

        Schema::create('finance_fixed_asset_writeoffs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('finance_fixed_asset_writeoffs');
    }
};
