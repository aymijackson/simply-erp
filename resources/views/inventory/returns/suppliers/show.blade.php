...
@section('title','Stock Return (Supplier) #'.$issue->issue_no)

@section('content')
<div class="container-fluid">
   <h1 class="h3 mb-3 text-primary">
       <i class="fas fa-dolly me-1"></i> Stock Return (Supplier) <small>#{{ $issue->stockIssue->issue_no ?? '-' }}</small>
   </h1>
    <div class="d-print-none">
          ...
          <a href="{{ route('admin.inventory.returns.supplier.index') }}"
   ...
   <div class="card mb-4 shadow-sm">
     <div class="card-body row g-3">
        <div class="col-md-3">
            <strong>From Store</strong><br>{{ $issue->store->name }}
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <strong>Reference</strong><br>{{ $issue->stockIssue->issue_no ?? '-' }}
        </div>
        <div class="col-md-12">
