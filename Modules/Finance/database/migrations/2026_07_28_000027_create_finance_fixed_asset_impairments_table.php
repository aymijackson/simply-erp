...
return new class extends Migration {
    ...
    {
        if (Schema::hasTable('finance_fixed_asset_impairments')) {
            return;
        }

        Schema::create('finance_fixed_asset_impairments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('finance_fixed_asset_impairments');
    }
};
