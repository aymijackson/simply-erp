    ...
    <div class="col-lg-6 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body text-center">
                ...
                <p>Add svg illustrations from <a href="https://undraw.co/" target="_blank" rel="nofollow">unDraw</a>, free and without attribution!</p>
                <a href="https://undraw.co/" target="_blank" rel="nofollow">Browse Illustrations on unDraw →</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>SB Admin 2 uses Bootstrap 4 utility classes to minimize CSS bloat and improve performance.</p>
                <p class="mb-0">Familiarize yourself with the Bootstrap framework, especially utility classes.</p>
            </div>
        </div>
    </div>
</div>
