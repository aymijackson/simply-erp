...
class AccountMappingController extends Controller
{
    ...
    public function upsert(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'wip_account_id'               => ['nullable', 'integer'],
            'finished_goods_account_id'    => ['nullable', 'integer'],
        ...
        $ids = array_values(array_filter([
            ...
            $data['wip_account_id'] ?? null,
            $data['finished_goods_account_id'] ?? null,
        ...
        $mapping = AccountMapping::updateOrCreate(
            ...
            [
                ...
                'wip_account_id'               => $data['wip_account_id'] ?? null,
                'finished_goods_account_id'    => $data['finished_goods_account_id'] ?? null,
