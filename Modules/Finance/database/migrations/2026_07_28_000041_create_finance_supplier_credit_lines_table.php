...
return new class extends Migration {
    ...
    {
        if (Schema::hasTable('finance_supplier_credit_lines')) {
            return;
        }

        Schema::create('finance_supplier_credit_lines', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('finance_supplier_credit_lines');
    }
};
